...
export function MyLink({to, name, boolean, className }: Props) {
  return (
    <Link href={to} replace={boolean} className={className}>
      <button
        type="button"
        className="relative w-full px-6 py-3 font-bold text-white group"
      >
